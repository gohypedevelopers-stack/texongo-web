  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="relative md:h-[100vh]">
        <section className="md:sticky md:top-0 md:h-screen bg-white z-10 flex items-center w-full overflow-hidden pt-8 md:pt-20 pb-8 md:pb-0">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="max-w-[1440px] mx-auto px-6 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16 items-center w-full mt-0 md:-mt-28 lg:-mt-36"
          >
            <div className="space-y-2 md:space-y-3">
              ...
              <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.1 }} className="text-center md:text-left px-4 flex flex-col-reverse md:flex-col gap-1">
            ...
            <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.2 }} className="space-y-4 md:space-y-8 text-center md:text-left">
              <div>
                <span className="text-xs font-black uppercase text-[#57AD43] mb-1 block">Legacy &amp; Journey</span>
                <h2 className="text-2xl md:text-5xl font-bold text-black mb-3 md:mb-6 tracking-tight">Our Legacy</h2>
                <p className="text-[14px] md:text-base font-medium text-gray-400 leading-relaxed uppercase">
                  <strong className="font-extrabold text-black">Syndicate Cloth House Pvt. Ltd. &amp; Texongo</strong> – A Legacy of Innovation and Trust.
                </p>
                <p className="text-[14px] md:text-base font-medium text-gray-500 leading-relaxed mt-4">
              ...
              <div>
                ...
                <p className="text-[14px] md:text-base font-medium text-gray-500 leading-relaxed">
      ...
      <div className="relative md:h-[100vh]">
        <section className="md:sticky md:top-0 md:h-screen bg-white z-10 flex items-center w-full overflow-hidden py-8 md:py-0">
          <div className="max-w-[1440px] mx-auto px-6 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16 items-center w-full">
            <motion.div {...fadeIn} className="order-2 lg:order-1 space-y-4 md:space-y-6 text-center md:text-left">
              <div>
                <span className="text-xs font-black uppercase text-[#57AD43] mb-1 block">Timeline</span>
                <h2 className="text-2xl md:text-5xl font-bold text-black mb-3 md:mb-6 tracking-tight">Growth &amp; Expansion</h2>
            ...
            <div className="order-1 lg:order-2 space-y-4 md:space-y-6">
              ...
              <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.3 }} className="text-center md:text-left px-4 flex flex-col-reverse md:flex-col gap-1">
      ...
      <div className="relative md:h-[100vh]">
        <section className="md:sticky md:top-0 md:h-screen bg-white z-30 flex items-center w-full overflow-hidden py-8 md:py-0">
          <div className="max-w-[1440px] mx-auto px-6 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16 items-center w-full">
            ...
            <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.2 }} className="space-y-4 md:space-y-6 text-center md:text-left">
              <span className="text-xs font-black uppercase text-[#57AD43] mb-1 block">Innovation</span>
              <h2 className="text-2xl md:text-5xl font-bold text-black mb-3 md:mb-6 tracking-tight">A New Chapter</h2>
              <div className="space-y-4">
                <p className="text-[14px] md:text-base font-medium text-gray-500 leading-relaxed">
      ...
      <section className="relative bg-white pt-8 pb-12 lg:pt-16 lg:pb-32 w-full z-40">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-20">
          ...
          {/* Cards Grid / Carousel */}
          <div className="flex md:grid overflow-x-auto snap-x snap-mandatory hide-scroll md:grid-cols-3 gap-4 md:gap-8 lg:gap-10 pb-8 md:pb-0">
            {/* Card 1 */}
            <motion.div
              {...fadeIn}
              className="relative w-[85%] sm:w-[60%] md:w-auto snap-center shrink-0 rounded-[2rem] overflow-hidden bg-gradient-to-br from-[#57AD43] via-[#4a9a38] to-[#2d6e20] p-6 md:p-8 lg:p-10 min-h-[280px] md:min-h-[350px] lg:min-h-[400px] shadow-[0_20px_50px_rgba(87,173,67,0.2)] group hover:-translate-y-4 hover:shadow-[0_30px_60px_rgba(87,173,67,0.3)] transition-all duration-500 flex flex-col justify-center"
            >
              ...
              <div className="absolute -bottom-8 -right-4 text-[120px] md:text-[160px] font-black text-white/5 leading-none select-none pointer-events-none transition-all duration-700 group-hover:scale-110 group-hover:text-white/10 group-hover:-translate-y-4">
                01
              </div>
              <div className="relative z-10">
                <div className="w-12 h-1 bg-white/30 rounded-full mb-6 md:mb-8 transition-all duration-500 group-hover:w-20 group-hover:bg-white/60" />
                <p className="text-white/95 text-[14px] md:text-base leading-[1.8] md:leading-[2] font-normal relative z-10">
