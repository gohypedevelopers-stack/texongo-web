  ...
  return (
    <main className="min-h-screen bg-white -mt-16">
      ...
      <div className="w-full bg-white relative pb-32">
        {/* Spacer before first sticky to make it scroll naturally into place */}
        <div className="space-y-32 lg:space-y-[30vh]">
          
          {/* Section 1: Legacy & Journey */}
          <section className="sticky top-0 bg-white z-10 py-12 lg:py-24 w-full">
          ...
          <section className="sticky top-0 bg-white z-20 py-12 lg:py-24 shadow-[0_-20px_40px_rgba(0,0,0,0.04)] w-full rounded-t-[3rem]">
            <div className="max-w-[1440px] mx-auto px-6 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <section className="sticky top-0 bg-white z-30 py-12 lg:py-24 shadow-[0_-20px_40px_rgba(0,0,0,0.04)] w-full rounded-t-[3rem] min-h-[100vh] flex flex-col justify-center">
        ...
        </div> {/* End of sticky sections wrapper */}

        {/* Section 4: Commitment — Three Cards Grid */}
        <section className="relative bg-white py-16 lg:py-24 w-full">
