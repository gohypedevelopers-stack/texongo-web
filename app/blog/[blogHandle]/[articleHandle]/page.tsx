...
export default async function BlogPostPage({
  ...
  return (
    <main className="min-h-screen bg-white pb-24">
      {/* Article Header & Breadcrumbs Area */}
      <div className="bg-[#FDFDFD] border-b border-gray-100">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          <nav className="py-6 flex items-center gap-2 text-[12px] font-medium text-gray-400 uppercase tracking-wider">
            <Link href="/" className="hover:text-[#57AD43] transition-colors">Home</Link>
            <span className="opacity-30">/</span>
            <Link href="/blog" className="hover:text-[#57AD43] transition-colors">{article.blog?.title || "Blog"}</Link>
            <span className="opacity-30">/</span>
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8 mt-12">
        <header className="mb-12">
          <h1 className="text-3xl md:text-5xl lg:text-7xl font-black text-[#121212] leading-[1.05] mb-8 uppercase tracking-tighter">
            {article.title}
          </h1>
          
          <div className="flex flex-wrap items-center gap-6 text-[11px] font-black uppercase tracking-[0.2em] text-gray-400">
        ...
        {article.tags && article.tags.length > 0 && (
          <div className="mt-20 pt-10 border-t border-gray-100 flex flex-wrap items-center gap-6">
            <span className="text-[11px] font-black uppercase tracking-widest text-[#121212]">Filed Under:</span>
        ...
        <section className="mt-24 bg-gray-50 p-10 lg:p-16 rounded-sm">
          <h3 className="text-3xl font-black uppercase tracking-tighter text-[#121212] mb-3">Leave a Reply</h3>
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="md:col-span-2">
              <label className="block text-[11px] font-black uppercase tracking-widest text-[#121212] mb-4">Comment *</label>
              <textarea 
                rows={6}
            ...
            <div>
              <label className="block text-[11px] font-black uppercase tracking-widest text-[#121212] mb-4">Name *</label>
              <input 
                type="text" 
            ...
            <div>
              <label className="block text-[11px] font-black uppercase tracking-widest text-[#121212] mb-4">Email *</label>
              <input 
                type="email" 
                className="w-full p-5 bg-white border border-gray-100 focus:border-[#57AD43] outline-none transition-all rounded-sm text-[16px]"
            ...
            <div className="md:col-span-2">
              <button 
                type="submit"
                className="px-16 py-6 bg-[#121212] text-white text-[12px] font-black uppercase tracking-[0.2em] hover:bg-[#57AD43] transition-all rounded-sm shadow-xl shadow-black/5"
              >
                Post Comment
              </button>
            </div>
